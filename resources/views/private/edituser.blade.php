    ...
    <div class="flex flex-1">
        ...
        <main class="flex-1 w-full lg:ml-64 p-4 lg:p-8">
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-xl lg:text-3xl font-semibold text-gray-800">Editar Usuario</h2>
                <div>
            ...
            <section class="mb-12">
                <div class="bg-white rounded-lg shadow p-4 lg:p-6">
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mb-6">
                            <div>
                                <label for="password" class="block text-xs lg:text-sm font-medium text-gray-700 mb-1">Nueva
                                    Contraseña (dejar en blanco para mantener la actual)</label>
                                <input type="password" name="password" id="password"
                                       class="w-full p-2 border border-gray-300 rounded-md text-sm">
                            </div>
                            <div>
                                <label for="password_confirmation"
                                       class="block text-xs lg:text-sm font-medium text-gray-700 mb-1">Confirmar Nueva
                                    Contraseña</label>
