...
<head>
    ...
    <title>Login - Cafeteria Bonifacio</title>
</head>
        ...
        <div class="bg-white rounded-xl shadow-2xl overflow-hidden animate__animated animate__fadeInUp">
            ...
            <div class="bg-[#f39c12] py-8 px-6 relative">
                <div class="text-center">
                    <i class="fas fa-user-circle text-5xl text-white mb-3"></i>
                    <h2 class="text-2xl font-bold text-white">Bienvenido de nuevo</h2>
                    <p class="text-white/80 mt-2">Inicia sesión para acceder a tu cuenta</p>
                </div>

                <!-- Decorative wave - fixed with lower height and optimized viewBox -->
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input type="checkbox" id="remember" name="remember"
                                   class="h-4 w-4 text-[#f39c12] border-gray-300 rounded focus:ring-[#f39c12]">
                            <label for="remember" class="ml-2 block text-sm text-[#2c3e50]">
                                Recuérdame
                            </label>
                        </div>
                        <div class="text-sm">
                            <a href="#" class="font-medium text-[#f39c12] hover:text-[#e67e22]">
